...
rule_explenation_en = {
    ...
    "rule_ufunc_threshold": "Detection rule, flag values based on operator and threshold value",
    "rule_diff_ufunc_threshold": "Detection rule, flag values based on diff, operator and threshold",
    "rule_other_ufunc_threshold": "Detection rule, flag values based on other series and threshold.",
    "rule_spike_detection": "Detection rule, identify spikes in timeseries and set to NaN",
    "rule_offset_detection": "Detection rule, detect periods with an offset error",
    "rule_outside_n_sigma": "Detection rule, set values outside of n * standard deviation to NaN",
    "rule_diff_outside_of_n_sigma": "Detection rule, calculate diff of series and identify suspect",
    "rule_outside_bandwidth": "Detection rule, set suspect values to NaN if outside bandwidth",
    "rule_pastas_outside_pi": "Detection rule, flag values based on pastas model prediction interval",
    "rule_pastas_percentile_pi": "",
    "rule_keep_comments": "Filter rule, modify timeseries to keep data with certain comments",
    "rule_shift_to_manual_obs": "Adjustment rule, for shifting timeseries onto manual observations",
    "rule_combine_nan_or": "Combination rule, combine NaN values for any number of timeseries",
    "rule_combine_nan_and": "Combination rule, combine NaN values for any number of timeseries",
...
rule_explenation_nl = {
    ...
    "rule_pastas_outside_pi": "Detectie-regel, signaleer op basis van het voorspellingsinterval van een pastas model",
    "rule_pastas_percentile_pi": "",
    "rule_keep_comments": "Filter rule, pas reeks aan in waardeb met bepaalde opmerkingen te behouden",
    "rule_shift_to_manual_obs": "Aanpassing-regel, pas waarden aan op basis van handmatige metingen",
    "rule_combine_nan_or": "Combinatie-regel, signaleer waar één van de regels is geactiveerd",
    "rule_combine_nan_and": "Combinatie-regel, signaleer waar alle regels zijn geactiveerd",
